...
class PreOrder:
    def __init__(self, driver, wait):
        ...
        self.locator_credit_card_button = self.locator['CHEQ-LOCATOR']['credit_card_button']
        self.locator_verify_subtotal_button = self.locator['CHEQ-LOCATOR']['verify_subtotal_button']
        self.locator_verify_credit_card = self.locator['CHEQ-LOCATOR']['verify_credit_card']
