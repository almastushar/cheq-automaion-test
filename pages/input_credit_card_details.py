...
class CreditCardDetails:
    def __init__(self, driver, wait):
        ...
        self.driver = driver
        self.wait = wait
        self.locator_iframe_card_number = locator['CHEQ-LOCATOR']['iframe_card_number']
        self.locator_iframe_expiry_date = locator['CHEQ-LOCATOR']['iframe_expiry_date']
        self.locator_iframe_cvc = locator['CHEQ-LOCATOR']['iframe_cvc']
        self.locator_card_number = locator['CHEQ-LOCATOR']['card_number']
        self.locator_expiry_date = locator['CHEQ-LOCATOR']['expiry_date']
        self.locator_cvc = locator['CHEQ-LOCATOR']['cvc']
        self.locator_name_on_card = locator['CHEQ-LOCATOR']['name_on_card']
        ...
        self.locator_verify_order_completed = locator['CHEQ-LOCATOR']['verify_order_completed']
        self.locator_verify_purchase_failed_with_cc = locator['CHEQ-LOCATOR']['verify_purchase_failed_with_cc']
